<template>
    <div class="question-cell">
        ...
        <h4 @click="toQuestion()">当前经济形势下，安全稳健的投资策略是什么？</h4>
        <nav>
        ...
        <section>
            ...
            <p>如今我们处在一个非常关键的时期，如今我们处在一个非常关键的时期，如今我们处在一个非常关键的时期，如今我们处在一个非常关键的时...<a @click="toQuestion()" href="javascript:;">阅读原文</a></p>
        </section>
        <aside>
