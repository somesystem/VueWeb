	...
	<div>
		<div class="common-person-order-top">
            ...
            <ol>
                ...
                <li><a href="javascript:;">正在交易</a></li>
                <li><a href="javascript:;">交易完成</a></li>
                <li><a href="javascript:;">无效订单</a></li>
            </ol>
        </div>
        <div class="order-box">
            <!--实际应通过item判断，12345均为测试，以下仅为显示方便，仅需要一个order-item即可
                ...
                以下仅为显示方便
            -->
        	<order-item :status="1" :has-licai="false"></order-item>
            <order-item :status="2" :has-licai="false"></order-item>
            <order-item :status="3" :has-licai="false"></order-item>
            <order-item :status="4" :has-licai="false"></order-item>
            <order-item :status="5" :has-licai="false"></order-item>
            <order-item :status="5" :has-licai="false"></order-item>
            <order-item :status="5" :has-licai="false"></order-item>
            <order-item :status="5" :has-licai="false"></order-item>
